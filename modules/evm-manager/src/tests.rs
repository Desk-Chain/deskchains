...
fn name_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::name(CurrencyId::Token(TokenSymbol::DESK)),
				Some(b"Deskchains".to_vec())
			);
			assert_eq!(
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::name(CurrencyId::DexShare(DexShare::Token(TokenSymbol::DESK), DexShare::Token(TokenSymbol::DUSD))),
				Some(b"LP Deskchains - Deskchains Dollar".to_vec())
			);

			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::name(CurrencyId::DexShare(DexShare::Erc20(erc20_address()), DexShare::Token(TokenSymbol::DUSD))),
				Some(b"LP long string name, long string name, long string name, long string name, long string name - Deskchains Dollar"[..32].to_vec())
			);
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::name(CurrencyId::DexShare(DexShare::Token(TokenSymbol::DESK), DexShare::Erc20(erc20_address_not_exists()))),
				None
			);
...
fn symbol_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::symbol(CurrencyId::Token(TokenSymbol::DESK)),
				Some(b"DESK".to_vec())
			);
			assert_eq!(
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::symbol(CurrencyId::DexShare(
					DexShare::Token(TokenSymbol::DESK),
					DexShare::Token(TokenSymbol::DUSD)
				)),
...
fn decimals_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::decimals(CurrencyId::Token(TokenSymbol::DESK)),
				Some(12)
			);
			assert_eq!(
...
fn encode_evm_address_works() {
	ExtBuilder::default()
		...
		.execute_with(|| {
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::encode_evm_address(CurrencyId::Token(TokenSymbol::DESK)),
		...
		.execute_with(|| {
			...
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::decode_evm_address(
					EvmCurrencyIdMapping::<Runtime>::encode_evm_address(CurrencyId::Token(TokenSymbol::DESK)).unwrap()
				),
				Some(CurrencyId::Token(TokenSymbol::DESK))
			);
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::decode_evm_address(
			...
			// CurrencyId::DexShare(DexShare::Token(TokenSymbol::DESK),
			// DexShare::Erc20(erc20_address_not_exists()))
			assert_eq!(
				EvmCurrencyIdMapping::<Runtime>::decode_evm_address(
